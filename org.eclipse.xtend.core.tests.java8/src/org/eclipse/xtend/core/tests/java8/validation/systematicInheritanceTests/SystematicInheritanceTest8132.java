 ...
 * 		void method(int arg);
 * 	}
 * 	public abstract static class IC implements I2 {
 * 	}
 * }
 * </code></pre>
 *
...
@SuppressWarnings("all")
public class SystematicInheritanceTest8132 extends AbstractXtendTestCase {
	...
	public void invalidInheritanceCase() throws Exception {
		EObject resource = file(
			...
			+ "	def void method(int arg)\n"
			+ "}\n"
			+ "public abstract class IC implements I2 {\n"
			+ "}\n", false, true);

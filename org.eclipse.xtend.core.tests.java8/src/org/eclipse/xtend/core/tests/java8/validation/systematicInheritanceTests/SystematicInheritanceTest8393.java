 ...
 * <p>javac output:
 * <pre><code>
 * mypack/SystematicInheritanceTest.java:5: error: class C inherits unrelated defaults for method(int) from types I1 and I2
 * 	public static class C extends IC implements I1 {
 * 	              ^
 * 1 error
 * </code></pre>
...
@SuppressWarnings("all")
public class SystematicInheritanceTest8393 extends AbstractXtendTestCase {

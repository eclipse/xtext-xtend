 ...
 * <p>javac output:
 * <pre><code>
 * mypack/SystematicInheritanceTest.java:5: error: class C inherits unrelated defaults for method(int) from types I1 and I3
 * 	public static class C extends IC implements I1, I3 {
 * 	              ^
 * 1 error
 * </code></pre>
...
@SuppressWarnings("all")
public class SystematicInheritanceTest3227 extends AbstractXtendTestCase {

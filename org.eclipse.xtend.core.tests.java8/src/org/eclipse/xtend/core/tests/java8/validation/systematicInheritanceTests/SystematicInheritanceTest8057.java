 ...
 *
 * 	public static class C extends IC implements I1 {
 * 	}
 * 	public interface I1 {
 * 		void method(int arg);
 * 	}
 ...
 * 	}
 * 	public abstract static class IC implements I1 {
 * 	}
 * }
 * </code></pre>
 *
 * <p>javac output:
 * <pre><code>
 * mypack/SystematicInheritanceTest.java:5: error: C is not abstract and does not override abstract method method(int) in I1
 * 	public static class C extends IC implements I1 {
 * 	              ^
 * 1 error
 * </code></pre>
...
@SuppressWarnings("all")
public class SystematicInheritanceTest8057 extends AbstractXtendTestCase {
	...
	public void invalidInheritanceCase() throws Exception {
		EObject resource = file(
			"public class C extends IC implements I1 {\n"
			+ "}\n"
			+ "public interface I1 {\n"
			...
			+ "	def void method(int arg) {}\n"
			+ "}\n"
			+ "public abstract class IC implements I1 {\n"
			+ "}\n", false, true);

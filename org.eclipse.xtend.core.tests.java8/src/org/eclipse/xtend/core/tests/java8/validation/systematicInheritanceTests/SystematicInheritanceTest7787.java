 ...
 * <p>javac output:
 * <pre><code>
 * mypack/SystematicInheritanceTest.java:5: error: C is not abstract and does not override abstract method method(int) in I2
 * 	public static class C extends IC implements I1 {
 * 	              ^
 * 1 error
 * </code></pre>
...
@SuppressWarnings("all")
public class SystematicInheritanceTest7787 extends AbstractXtendTestCase {

 ...
 * <p>javac output:
 * <pre><code>
 * mypack/SystematicInheritanceTest.java:5: error: C is not abstract and does not override abstract method method(int) in I3
 * 	public static class C extends IC implements I1, I3 {
 * 	              ^
 * 1 error
 * </code></pre>
...
@SuppressWarnings("all")
public class SystematicInheritanceTest3647 extends AbstractXtendTestCase {

...
public class TryWithResourcesTest extends AbstractXtendCompilerTest {
  ...
  public void test_easyResource() {
    ...
    StringConcatenation _builder_1 = new StringConcatenation();
    _builder_1.append("      ");
    _builder_1.append("final StringReader a = new StringReader(this.s);");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("try {");
    _builder_1.newLine();
  ...
  public void test_assumeTypeAutoClosable() {
    ...
    StringConcatenation _builder_1 = new StringConcatenation();
    _builder_1.append("      ");
    _builder_1.append("final AutoCloseable someCloseable = null;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("try {");
    _builder_1.newLine();
  ...
  public void test_twoResources() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final BufferedReader buffy = new BufferedReader(sr);");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("try {");
    _builder_1.newLine();
  ...
  public void test_twoNestedResources() {
    ...
    StringConcatenation _builder_1 = new StringConcatenation();
    _builder_1.append("      ");
    _builder_1.append("final BufferedReader br = new BufferedReader(new StringReader(this.s));");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("try {");
    _builder_1.newLine();
  ...
  public void test_twoNestedResourcesOneDefinedOutside() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final BufferedReader br = new BufferedReader(sr);");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("try {");
    _builder_1.newLine();
  ...
  public void test_nestedIf1() {
    ...
    StringConcatenation _builder_1 = new StringConcatenation();
    _builder_1.append("      ");
    _builder_1.append("final StringReader fr = new StringReader(new Function0<String>() {");
    _builder_1.newLine();
    _builder_1.append("        ");
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final BufferedReader br = new BufferedReader(fr);");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("try {");
    _builder_1.newLine();

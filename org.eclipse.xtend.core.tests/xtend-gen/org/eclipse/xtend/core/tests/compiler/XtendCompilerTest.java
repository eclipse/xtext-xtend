...
public class XtendCompilerTest extends AbstractXtendCompilerTest {
  ...
  public void testMultiCatch_01() {
    ...
    _builder.newLine();
    _builder.append("   \t  \t ");
    _builder.append("<IllegalArgumentException>throwsSomething;");
    _builder.newLine();
    _builder.append("   \t  \t ");
    _builder.append("<IllegalStateException>throwsSomething");
    _builder.newLine();
    _builder.append("   \t  ");
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("this.<IllegalArgumentException>throwsSomething();");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("this.<IllegalStateException>throwsSomething();");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("} catch (final Throwable _t) {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("if (_t instanceof IllegalArgumentException || _t instanceof IllegalStateException) {");
    _builder_1.newLine();
    _builder_1.append("          ");
  ...
  @Test
  public void testSwitchWithMultiType_01() {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("public class C  {");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("IllegalArgumentException | IllegalStateException: a.message");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("if (a instanceof IllegalArgumentException || a instanceof IllegalStateException) {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("_matched=true;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("_switchResult = ((RuntimeException)a).getMessage();");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testSwitchWithBooleanExpression_3() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("if (((new Function0<Boolean>() {");
    _builder_1.newLine();
    _builder_1.append("      ");

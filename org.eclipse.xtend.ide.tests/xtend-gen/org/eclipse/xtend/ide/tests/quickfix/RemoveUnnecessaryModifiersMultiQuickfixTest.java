...
public class RemoveUnnecessaryModifiersMultiQuickfixTest extends AbstractMultiQuickfixTest {
  ...
  public void testRemoveUnnecessaryModifiersQuickfixXtend() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("<1<private>1> <2<final>2> val <3<A>3> = 1");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def <4<public>4> m() {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("new Runnable {");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<5<public>5> override <6<def>6> run() {}");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("3: message=The value of the field Foo.A is not used");
    _builder.newLine();
    _builder.append("4: message=The public modifier is unnecessary on method m");
    _builder.newLine();
    _builder.append("5: message=The public modifier is unnecessary on method run");
    _builder.newLine();
    _builder.append("6: message=The def modifier is unnecessary on method run");
    _builder.newLine();
